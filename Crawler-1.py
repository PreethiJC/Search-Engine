...
def open_url(url):
    ...
    keywords = ["world", "war", "ww2", "wwii", "united", "states", "u.s", "u.s.a", "america", "battle", "battles", "won",
...
frontier = OrderedDict()
seed_urls = ["http://www.history.com/topics/world-war-ii", "http://en.wikipedia.org/wiki/World_War_II", "http://en.wikipedia.org/wiki/Causes_of_World_War_II", "http://www.historyonthenet.com/ww2/causes.htm", "https://www2.bc.edu/zachary-s-laub/Facts.html"]
...
blackListURLs = ["http://en.wikipedia.org/wiki/International_Standard_Book_Number", "http://en.wikipedia.org/wiki/JSTOR",
                     ...
                     "http://en.wikipedia.org/wiki/Routledge", "http://en.wikipedia.org/wiki/Osprey_Publishing", "http://en.wikipedia.org/wiki/OCLC"]
blackListURLs = set(blackListURLs)
keywords =  ['world', 'war', 'nazi', 'germany', 'adolf', 'hitler', 'japan', 'america', 'united', 'states', 'history', 'pearl', 'harbour', 'nagasaki', 'hiroshima', 'italy', 'europe', 'conquest']
keywords = set(keywords)
start_time = time.time()
while discoveredTillNow < 120000 or len(visited_urls) < 120000:
    crawl()
